		...
		<form name="addStayForm" method="post" enctype="multipart/form-data" action="/editStayAction">
			<div class="store_apply_form">
				<ul class="form_dl">
					...
					<li><div class="dt">스테이 이름 *</div>
						<div class="dd">
							<input type="text" class="form_style" name="stayName" value="${ map.stayVO.stayName }"
					...
					<li><div class="dt">스테이 뷰 *</div>
						<div class="dd">
							<label for="mountain" class="radio_skin"> <input
								...
								type="radio" id="ocean" name="stayView" value="바다" ${ map.stayVO.stayView eq '바다' ? 'checked' : '' }> <span
			...
			<div class="store_apply_agree" style='display:none'>
				...
				<label for="check-policy1" class="check_skin"
					...
					type="checkbox" id="check-policy1" checked><span
